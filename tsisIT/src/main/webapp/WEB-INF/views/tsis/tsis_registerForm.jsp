...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style_delivery_tsis.css">
  <title>2021 연말 집콕 이벤트</title>
...
<body>
  <form method="post" id="mainform">
    <input type="hidden" id="gubun" name="gubun" value="202112">
    <div>
      <div class="wrap_header">
      	<div class="header">
           <img src="img/header-02.png" alt="tsis" />
        </div>  
		<!--
		<div class="header">
          <img src="img/logo_tsis.png" alt="tsis">
          <h1>코로나19 예방 위로 선물 배송 정보 입력</h1>
        </div> 
        -->
      </div>
      
      <!-- 211216추가 -->
      <div class="wrap_header_red">
          <div class="header">
              <img src="img/header-03.png" alt="tsis" />
          </div>
      </div>
      <!-- //211216추가 -->
      ...
      <div class="wrap_content">
        ...
        <div class="content">
          <h2>발신인 정보 입력</h2>
          <label>티시스 사번</label>
          <input type="text" id="s_id" name="s_id" style='width:200px' placeholder="사번을 입력해주세요.">
