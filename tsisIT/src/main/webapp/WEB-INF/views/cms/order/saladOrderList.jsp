    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">                
            ...
            <div class="search_form">
				...
				<div class="list_bot">
					<div class="text-center paging"><p class="txt_count text-orange" style="margin-right:5px;"><b>총 접수건수 : <span id='totalCount'></span>건&nbsp; / 총 주문건수 : <span id='sumCount'></span>건</b></p></div>
					<br>
                       ...
                       <table class="table tbl_list tbl_fixed">
                           ...
                           <thead>
                               <tr>
								   ...
								   <th scope="col">메뉴 A 수량</th>
                                   <th scope="col">메뉴 B 수량</th>
								   <th scope="col">상태</th>
